...
void setupInt() {
    ...
    int_cls->giveAttr("__getnewargs__", new BoxedFunction(BoxedCode::create((void*)int_getnewargs, UNKNOWN, 1,
    ...
    int_cls->giveAttr("__radd__", new BoxedFunction(BoxedCode::create((void*)intRAdd, UNKNOWN, 2)));
    int_cls->giveAttr("__rand__", new BoxedFunction(BoxedCode::create((void*)intRAnd, UNKNOWN, 2)));
    int_cls->giveAttr("__ror__", new BoxedFunction(BoxedCode::create((void*)intROr, UNKNOWN, 2)));
    int_cls->giveAttr("__rxor__", new BoxedFunction(BoxedCode::create((void*)intRXor, UNKNOWN, 2)));

    int_cls->giveAttr("__rsub__", new BoxedFunction(BoxedCode::create((void*)intRSub, UNKNOWN, 2)));
    int_cls->giveAttr("__rmul__", new BoxedFunction(BoxedCode::create((void*)intRMul, UNKNOWN, 2)));
    int_cls->giveAttr("__rdiv__", new BoxedFunction(BoxedCode::create((void*)intRDiv, UNKNOWN, 2)));
    int_cls->giveAttr("__rfloordiv__", new BoxedFunction(BoxedCode::create((void*)intRFloordiv, UNKNOWN, 2)));
    int_cls->giveAttr("__rtruediv__", new BoxedFunction(BoxedCode::create((void*)intRTruediv, UNKNOWN, 2)));
    int_cls->giveAttr("__rmod__", new BoxedFunction(BoxedCode::create((void*)intRMod, UNKNOWN, 2)));
    int_cls->giveAttr("__rdivmod__", new BoxedFunction(BoxedCode::create((void*)intRDivmod, UNKNOWN, 2)));
    int_cls->giveAttr("__rpow__",
                      new BoxedFunction(BoxedCode::create((void*)intRPow, UNKNOWN, 3, false, false), { Py_None }));
    int_cls->giveAttr("__rrshift__", new BoxedFunction(BoxedCode::create((void*)intRRShift, UNKNOWN, 2)));
    int_cls->giveAttr("__rlshift__", new BoxedFunction(BoxedCode::create((void*)intRLShift, UNKNOWN, 2)));
    ...
    int_cls->giveAttr("__invert__", new BoxedFunction(BoxedCode::create((void*)intInvert, BOXED_INT, 1)));
    int_cls->giveAttr("__pos__", new BoxedFunction(BoxedCode::create((void*)intPos, BOXED_INT, 1)));
    int_cls->giveAttr("__neg__", new BoxedFunction(BoxedCode::create((void*)intNeg, UNKNOWN, 1)));
    int_cls->giveAttr("__nonzero__", new BoxedFunction(BoxedCode::create((void*)intNonzero, BOXED_BOOL, 1)));
    int_cls->giveAttr("__repr__", new BoxedFunction(BoxedCode::create((void*)intRepr, STR, 1)));
    int_cls->tp_hash = (hashfunc)int_hash;
    int_cls->giveAttr("__divmod__", new BoxedFunction(BoxedCode::create((void*)intDivmod, UNKNOWN, 2)));


    int_cls->giveAttr("__coerce__", new BoxedFunction(BoxedCode::create((void*)intCoerce, UNKNOWN, 2)));
    int_cls->giveAttr("__abs__", new BoxedFunction(BoxedCode::create((void*)intAbs, UNKNOWN, 1)));
    int_cls->giveAttr("__bin__", new BoxedFunction(BoxedCode::create((void*)intBin, STR, 1)));
    int_cls->giveAttr("__hex__", new BoxedFunction(BoxedCode::create((void*)intHex, STR, 1)));
    int_cls->giveAttr("__oct__", new BoxedFunction(BoxedCode::create((void*)intOct, STR, 1)));

    int_cls->giveAttr("__trunc__", new BoxedFunction(BoxedCode::create((void*)intTrunc, BOXED_INT, 1)));
    int_cls->giveAttr("__index__", new BoxedFunction(BoxedCode::create((void*)intIndex, BOXED_INT, 1)));
    int_cls->giveAttr("__int__", new BoxedFunction(BoxedCode::create((void*)intInt, BOXED_INT, 1)));
    int_cls->giveAttr("__float__", new BoxedFunction(BoxedCode::create((void*)intFloat, BOXED_FLOAT, 1)));
    int_cls->giveAttr("__long__", new BoxedFunction(BoxedCode::create((void*)intLong, LONG, 1)));

    int_cls->giveAttr("__format__", new BoxedFunction(BoxedCode::create((void*)intFormat, STR, 2)));
    ...
    auto int_new
        = BoxedCode::create((void*)intNew<CXX>, UNKNOWN, 3, false, false, ParamNames({ "", "x", "base" }, "", ""), CXX);
    int_new->addVersion((void*)intNew<CAPI>, UNKNOWN, CAPI);
    int_cls->giveAttr("__new__", new BoxedFunction(int_new, { NULL, NULL }));


    int_cls->giveAttr("bit_length", new BoxedFunction(BoxedCode::create((void*)intBitLength, BOXED_INT, 1)));
    ...
    int_cls->giveAttr("conjugate", new BoxedFunction(BoxedCode::create((void*)int_int_getset, BOXED_INT, 1)));
