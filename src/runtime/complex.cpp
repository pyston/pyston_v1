...
void setupComplex() {
    ...
    auto complex_new_func = BoxedCode::create((void*)complexNew<CXX>, UNKNOWN, 3, false, false,
    ...
    complex_cls->giveAttr("__rsub__", new BoxedFunction(BoxedCode::create((void*)complexRSub, UNKNOWN, 2)));
    complex_cls->giveAttr("__rdiv__", new BoxedFunction(BoxedCode::create((void*)complexRDiv, UNKNOWN, 2)));
    complex_cls->giveAttr(
        "__pow__", new BoxedFunction(BoxedCode::create((void*)complexPow, UNKNOWN, 3, false, false), { Py_None }));
    complex_cls->giveAttr("__rpow__", new BoxedFunction(BoxedCode::create((void*)complexRPow, UNKNOWN, 2)));

    complex_cls->giveAttr("__mod__", new BoxedFunction(BoxedCode::create((void*)complexMod, UNKNOWN, 2)));
    complex_cls->giveAttr("__rmod__", new BoxedFunction(BoxedCode::create((void*)complexRMod, UNKNOWN, 2)));
    complex_cls->giveAttr("__divmod__", new BoxedFunction(BoxedCode::create((void*)complexDivmod, UNKNOWN, 2)));
    complex_cls->giveAttr("__rdivmod__", new BoxedFunction(BoxedCode::create((void*)complexRDivmod, UNKNOWN, 2)));
    ...
    complex_cls->giveAttr("__truediv__", new BoxedFunction(BoxedCode::create((void*)complexTruediv, UNKNOWN, 2)));
    ...
    complex_cls->giveAttr("__coerce__", new BoxedFunction(BoxedCode::create((void*)complexCoerce, UNKNOWN, 2)));
    complex_cls->giveAttr("__abs__", new BoxedFunction(BoxedCode::create((void*)complexAbs, BOXED_FLOAT, 1)));
    complex_cls->giveAttr("__getnewargs__",
                          new BoxedFunction(BoxedCode::create((void*)complexGetnewargs, BOXED_TUPLE, 1)));
    complex_cls->giveAttr("__nonzero__", new BoxedFunction(BoxedCode::create((void*)complexNonzero, BOXED_BOOL, 1)));
    complex_cls->giveAttr("__eq__", new BoxedFunction(BoxedCode::create((void*)complexEq, UNKNOWN, 2)));
    complex_cls->giveAttr("__ne__", new BoxedFunction(BoxedCode::create((void*)complexNe, UNKNOWN, 2)));
    complex_cls->giveAttr("__le__", new BoxedFunction(BoxedCode::create((void*)complexLe, UNKNOWN, 2)));
    complex_cls->giveAttr("__lt__", new BoxedFunction(BoxedCode::create((void*)complexLt, UNKNOWN, 2)));
    complex_cls->giveAttr("__ge__", new BoxedFunction(BoxedCode::create((void*)complexGe, UNKNOWN, 2)));
    complex_cls->giveAttr("__gt__", new BoxedFunction(BoxedCode::create((void*)complexGt, UNKNOWN, 2)));
    complex_cls->giveAttr("__neg__", new BoxedFunction(BoxedCode::create((void*)complexNeg, BOXED_COMPLEX, 1)));
    complex_cls->giveAttr("__pos__", new BoxedFunction(BoxedCode::create((void*)complexPos, BOXED_COMPLEX, 1)));
    complex_cls->giveAttr("__hash__", new BoxedFunction(BoxedCode::create((void*)complexHash, BOXED_INT, 1)));
    complex_cls->giveAttr("__str__", new BoxedFunction(BoxedCode::create((void*)complexStr<CXX>, STR, 1)));
    complex_cls->giveAttr("__int__", new BoxedFunction(BoxedCode::create((void*)complexInt, UNKNOWN, 1)));
    complex_cls->giveAttr("__float__", new BoxedFunction(BoxedCode::create((void*)complexFloat, UNKNOWN, 1)));
    complex_cls->giveAttr("__long__", new BoxedFunction(BoxedCode::create((void*)complexLong, UNKNOWN, 1)));
    complex_cls->giveAttr("__repr__", new BoxedFunction(BoxedCode::create((void*)complexRepr<CXX>, STR, 1)));
