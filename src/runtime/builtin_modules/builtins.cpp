...
void setupBuiltins() {
    ...
    ellipsis_cls->giveAttr("__repr__", new BoxedFunction(BoxedCode::create((void*)ellipsisRepr, STR, 1)));
    ...
    notimplemented_cls = BoxedClass::create(type_cls, object_cls, 0, 0, sizeof(Box), false, "NotImplementedType", false,
                                            NULL, NULL, false);
    notimplemented_cls->giveAttr("__repr__", new BoxedFunction(BoxedCode::create((void*)notimplementedRepr, STR, 1)));
    ...
    builtins_module->giveAttr(
        "apply", new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)builtinApply, UNKNOWN, 3, false, false),
    ...
    auto len_func = BoxedCode::create((void*)len, UNKNOWN, 1);
    ...
    min_obj = new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)min, UNKNOWN, 1, true, true), "min",
                                               { Py_None }, NULL, min_doc);
    builtins_module->giveAttr("min", min_obj);

    max_obj = new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)max, UNKNOWN, 1, true, true), "max",
                                               { Py_None }, NULL, max_doc);
    builtins_module->giveAttr("max", max_obj);

    builtins_module->giveAttr("next",
                              new BoxedBuiltinFunctionOrMethod(
                                  BoxedCode::create((void*)next, UNKNOWN, 2, false, false, ParamNames::empty(), CAPI),
                                  "next", { NULL }, NULL, next_doc));

    builtins_module->giveAttr("sum",
                              new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)sum, UNKNOWN, 2, false, false),
                                                               "sum", { autoDecref(boxInt(0)) }, NULL, sum_doc));
    ...
    builtins_module->giveAttr("dump", new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)pydump, UNKNOWN, 2),
    ...
    auto getattr_func = new BoxedCode(3, true, true, ParamNames::empty());
    ...
    builtins_module->giveAttr(
        "setattr", new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)setattrFunc, UNKNOWN, 3, false, false),
                                                    "setattr", setattr_doc));

    auto hasattr_func = new BoxedCode(2, false, false);
    ...
    builtins_module->giveAttr(
        "pow", new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)powFunc, UNKNOWN, 3, false, false), "pow",
                                                { Py_None }, NULL, pow_doc));

    Box* isinstance_obj = new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)isinstance_func, BOXED_BOOL, 2),
                                                           "isinstance", isinstance_doc);
    builtins_module->giveAttr("isinstance", isinstance_obj);

    Box* issubclass_obj = new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)issubclass_func, BOXED_BOOL, 2),
    ...
    BoxedCode* import_func
        = BoxedCode::create((void*)bltinImport, UNKNOWN, 5, false, false,
    ...
    enumerate_cls->giveAttr("__new__",
                            new BoxedFunction(BoxedCode::create((void*)BoxedEnumerate::new_, UNKNOWN, 3,
    ...
    enumerate_cls->giveAttr("next", new BoxedFunction(BoxedCode::create((void*)BoxedEnumerate::next, BOXED_TUPLE, 1)));
    enumerate_cls->giveAttr("__hasnext__",
                            new BoxedFunction(BoxedCode::create((void*)BoxedEnumerate::hasnext, BOXED_BOOL, 1)));
    ...
    range_obj = new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)range, LIST, 3, false, false), "range",
                                                 { NULL, NULL }, NULL, range_doc);
    builtins_module->giveAttr("range", range_obj);

    auto* round_obj = new BoxedBuiltinFunctionOrMethod(
        BoxedCode::create((void*)builtinRound, BOXED_FLOAT, 2, ParamNames({ "number", "ndigits" }, "", "")), "round",
        { autoDecref(boxInt(0)) }, NULL, round_doc);
    ...
    open_obj = new BoxedBuiltinFunctionOrMethod(
        BoxedCode::create((void*)open, typeFromClass(&PyFile_Type), 3, false, false,
    ...
    builtins_module->giveAttr(
        "globals", new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)globals, UNKNOWN, 0, false, false),
                                                    "globals", globals_doc));
    builtins_module->giveAttr(
        "locals", new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)locals, UNKNOWN, 0, false, false), "locals",
                                                   locals_doc));

    builtins_module->giveAttr(
        "iter", new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)builtinIter, UNKNOWN, 2, false, false),
                                                 "iter", { NULL }, NULL, iter_doc));
    builtins_module->giveAttr(
        "reversed",
        new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)getreversed, UNKNOWN, 1, false, false), "reversed"));
    builtins_module->giveAttr(
        "coerce", new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)coerceFunc, UNKNOWN, 2, false, false),
                                                   "coerce", coerce_doc));
    builtins_module->giveAttr(
    ...
    builtins_module->giveAttr(
        "reduce", new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)reduce, UNKNOWN, 3, false, false), "reduce",
                                                   { NULL }, NULL, reduce_doc));
    builtins_module->giveAttr("filter", new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)filter2, UNKNOWN, 2),
                                                                         "filter", filter_doc));
    builtins_module->giveAttr(
        "zip", new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)zip, LIST, 0, true, false), "zip", zip_doc));
    builtins_module->giveAttr("dir",
                              new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)dir, LIST, 1, false, false),
                                                               "dir", { NULL }, NULL, dir_doc));
    builtins_module->giveAttr("vars",
                              new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)vars, UNKNOWN, 1, false, false),
    ...
    builtins_module->giveAttr(
        "callable",
        new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)callable, UNKNOWN, 1), "callable", callable_doc));

    builtins_module->giveAttr(
        "raw_input", new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)rawInput, UNKNOWN, 1, false, false),
                                                      "raw_input", { NULL }, NULL, raw_input_doc));
    builtins_module->giveAttr(
        "input", new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)input, UNKNOWN, 1, false, false), "input",
                                                  { NULL }, NULL, input_doc));
    builtins_module->giveAttr(
        "cmp", new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)builtinCmp, UNKNOWN, 2), "cmp", cmp_doc));
    builtins_module->giveAttr("format",
                              new BoxedBuiltinFunctionOrMethod(BoxedCode::create((void*)builtinFormat, UNKNOWN, 2),
                                                               "format", { NULL }, NULL, format_doc));
