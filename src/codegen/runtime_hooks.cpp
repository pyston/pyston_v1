...
static llvm::Value* addFunc(void *func, llvm::Type* rtn_type, llvm::ArrayRef<llvm::Type*> arg_types, bool varargs=false) {
...
static llvm::Value* addFunc(void *func, llvm::Type* rtn_type, llvm::Type* arg1, llvm::Type* arg2, bool varargs=false) {
    llvm::Type* array[] = {arg1, arg2};
    return addFunc(func, rtn_type, array, varargs);
}

static llvm::Value* addFunc(void *func, llvm::Type* rtn_type, llvm::Type* arg1, llvm::Type* arg2, llvm::Type* arg3, bool varargs=false) {
    llvm::Type* array[] = {arg1, arg2, arg3};
    return addFunc(func, rtn_type, array, varargs);
}

static llvm::Value* addFunc(void *func, llvm::Type* rtn_type, llvm::Type* arg1, llvm::Type* arg2, llvm::Type* arg3, llvm::Type* arg4, bool varargs=false) {
    llvm::Type* array[] = {arg1, arg2, arg3, arg4};
    return addFunc(func, rtn_type, array, varargs);
}

static llvm::Value* addFunc(void *func, llvm::Type* rtn_type, llvm::Type* arg1, llvm::Type* arg2, llvm::Type* arg3, llvm::Type* arg4, llvm::Type* arg5, bool varargs=false) {
    llvm::Type* array[] = {arg1, arg2, arg3, arg4, arg5};
    return addFunc(func, rtn_type, array, varargs);
}

static llvm::Value* addFunc(void *func, llvm::Type* rtn_type, llvm::Type* arg1, llvm::Type* arg2, llvm::Type* arg3, llvm::Type* arg4, llvm::Type* arg5, llvm::Type* arg6, bool varargs=false) {
    llvm::Type* array[] = {arg1, arg2, arg3, arg4, arg5, arg6};
    return addFunc(func, rtn_type, array, varargs);
}

static llvm::Value* addFunc(void *func, llvm::Type* rtn_type, llvm::Type* arg1, llvm::Type* arg2, llvm::Type* arg3, llvm::Type* arg4, llvm::Type* arg5, llvm::Type* arg6, llvm::Type* arg7, bool varargs=false) {
...
#define GET(N) g.funcs.N = getFunc((void*)N, STRINGIFY(N))
    ...
    g.funcs.runtimeCall1 = addFunc((void*)runtimeCall, g.llvm_value_type_ptr, g.llvm_value_type_ptr, g.i64, g.llvm_value_type_ptr);
    g.funcs.runtimeCall2 = addFunc((void*)runtimeCall, g.llvm_value_type_ptr, g.llvm_value_type_ptr, g.i64, g.llvm_value_type_ptr, g.llvm_value_type_ptr);
    g.funcs.runtimeCall3 = addFunc((void*)runtimeCall, g.llvm_value_type_ptr, g.llvm_value_type_ptr, g.i64, g.llvm_value_type_ptr, g.llvm_value_type_ptr, g.llvm_value_type_ptr);

    g.funcs.callattr = getFunc((void*)callattr, "callattr");
    g.funcs.callattr0 = addFunc((void*)callattr, g.llvm_value_type_ptr, g.llvm_value_type_ptr, g.llvm_str_type_ptr, g.i1, g.i64);
    g.funcs.callattr1 = addFunc((void*)callattr, g.llvm_value_type_ptr, g.llvm_value_type_ptr, g.llvm_str_type_ptr, g.i1, g.i64, g.llvm_value_type_ptr);
    g.funcs.callattr2 = addFunc((void*)callattr, g.llvm_value_type_ptr, g.llvm_value_type_ptr, g.llvm_str_type_ptr, g.i1, g.i64, g.llvm_value_type_ptr, g.llvm_value_type_ptr);
    g.funcs.callattr3 = addFunc((void*)callattr, g.llvm_value_type_ptr, g.llvm_value_type_ptr, g.llvm_str_type_ptr, g.i1, g.i64, g.llvm_value_type_ptr, g.llvm_value_type_ptr, g.llvm_value_type_ptr);
